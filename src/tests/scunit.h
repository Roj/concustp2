...
#define TEST(id)                                                                                             \
  ...
  __attribute__((constructor)) void scunit__##id##_reg(void) {                                               \
    scunit_register(scunit__##id##_test, #id, __FILE__);                                                     \
  }                                                                                                          \
  static void scunit__##id##_test(int *scunit__test_failed)
...
#define ASSERT_NE(not_expected, e)                                                                           \
  GEN_EXP_ASSERT(1, (e) != (not_expected), e, "different from '" #not_expected "'")
...
#define EXPECT_NE(not_expected, e)                                                                           \
  GEN_EXP_ASSERT(0, (e) != (not_expected), e, "different from '" #not_expected "'")
